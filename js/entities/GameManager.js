    ...
    setBuyText: function(){
      ...
      this.alwaysUpdate = true;
       ...
       draw:function(renderer){
              ...
              this.font.draw(renderer.getContext(), "W Ability: Eat Your Creep For Health: "+ game.data.ability2 + " Cost: " + ((game.data.ability2+1)+10), this.pos.x, this.pos.y+240);
              this.font.draw(renderer.getContext(), "E Ability: Throw Your Speed:"+ game.data.ability3 + " Cost: " + ((game.data.ability3+1)+10), this.pos.x, this.pos.y+280);
